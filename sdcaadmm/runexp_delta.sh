...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/delta.$1.tr.txt ./parallel-train -m 720000  -t 4000 -g 0.0000025 -a 0.0001 -z 50000 -b 2000  -c 1 -i /utmp/jkrecord/delta.4.1.interm  /utmp/delta_tr.4 

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/delta.$1.ts.txt ./parallel-predict -p /utmp/delta_tr.4 /utmp/delta_ts.4 /utmp/jkrecord/delta.4.1.interm
