...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/rcv1.$1.tr.txt ./parallel-train -m 11000  -t 550 -g 0.00000179 -a 0.1 -z 50 -b 188950  -c 1 -i /utmp/jkrecord/rcv1.4.1.interm  /utmp/rcv1_tr.4 

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/rcv1.$1.ts.txt ./parallel-predict -p /utmp/rcv1_tr.4 /utmp/rcv1_ts.4 /utmp/jkrecord/rcv1.4.1.interm
