...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/mnist47.$1.tr.txt ./parallel-train -m 600000  -t 10000 -g 0.000000764 -a 0.001 -z 5000 -b 3136  -c 1 -i /utmp/jkrecord/mnist47.4.1.interm  /utmp/mnist47_tr.4 

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/mnist47.$1.ts.txt ./parallel-predict -p /utmp/mnist47_tr.4 /utmp/mnist47_ts.4 /utmp/jkrecord/mnist47.4.1.interm
