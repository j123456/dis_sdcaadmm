...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/delta.$1.tr.txt ./parallel-train -m 800000  -t 4000 -c $2 -i /utmp/jkrecord/delta.psd.interm  /utmp/delta_tr.4 

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/delta.$1.ts.txt ./parallel-predict -p /utmp/delta_tr.4 /utmp/delta_ts.4 /utmp/jkrecord/delta.psd.interm
