...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/epsilon.$1.tr.txt ./parallel-train -m 400000 -t 4000  -c $2 -i /utmp/jkrecord/epsilon.psd.interm  /utmp/epsilon_normalized.4

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/epsilon.$1.ts.txt ./parallel-predict -p /utmp/epsilon_normalized.4 /utmp/epsilon_normalized.t.4 /utmp/jkrecord/epsilon.psd.interm
