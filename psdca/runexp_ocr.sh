...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/ocr.$1.tr.txt ./parallel-train -m 2800000  -t 28000  -c $2 -i /utmp/jkrecord/ocr.psd.interm  /utmp/ocr_tr.4 

mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/ocr.$1.ts.txt ./parallel-predict -p /utmp/ocr_tr.4 /utmp/ocr_ts.4 /utmp/jkrecord/ocr.psd.interm
