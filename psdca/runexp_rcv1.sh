...
mpirun --mca btl_tcp_if_include 192.168.160.0/24 --hostfile ../hostfile_4 -np 4 -output-filename /utmp/jkrecord/rcv1.$1.tr.txt ./parallel-train -m 11000  -t 550  -c $2 -i /utmp/jkrecord/rcv1.4.1.interm  /utmp/rcv1_tr.4 
