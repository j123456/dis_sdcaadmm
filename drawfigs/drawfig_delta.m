...
%pure   = csvread('delta_ori.txt');
%tw_1 = csvread('./repeat/delta_tw.txt');
%tw_1 = csvread('delta_tw.txt');
%icdm = csvread('delta_icdm.txt');
pure   = csvread('./repeat/delta_orif.txt');
tw_1 = csvread('./repeat/delta_twr.txt');
icdm = csvread('./repeat/delta_icdmf.txt');
psd  = csvread('./repeat/delta_psd.txt');
...
print('delta_ts_acc','-depsc2','-r300');
system('gs -o -q -sDEVICE=png256 -dEPSCrop -r300 -o delta_ts_acc.png delta_ts_acc.eps');
...
prettyPlot( xx, yy, options);
print('delta_tr_acc','-depsc2','-r300');
system('gs -o -q -sDEVICE=png256 -dEPSCrop -r300 -o delta_tr_acc.png delta_tr_acc.eps');
